...
class BaseOptimizer {
  public:
    ...
    BaseOptimizer(BaseFunction &obj, std::vector<Point2<double>> &var) : obj_(obj), var_(var) {}
...
class SimpleConjugateGradient : public BaseOptimizer {
  public:
    ...
    SimpleConjugateGradient(BaseFunction &obj, std::vector<Point2<double>> &var, const double &alpha, const vector<bool> &fixed);
